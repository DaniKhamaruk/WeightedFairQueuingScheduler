...
void update_min_time_for_all_heap_recursive(heap_node* current_heap_node,float total_weight_of_heap,
	...
	current_heap_node->flow->gps_parameters.time_remain -= weight_portion*delta_time_to_run;
	update_min_time_for_all_heap_recursive(current_heap_node->left_child,total_weight_of_heap, delta_time_to_run);
	update_min_time_for_all_heap_recursive(current_heap_node->right_child, total_weight_of_heap, delta_time_to_run);
}